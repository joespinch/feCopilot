...
# Aviso si el usuario pregunta por el modelo
modelo_keywords = ["modelo", "gpt-4", "gpt-4.1", "gpt4", "gpt 4", "gpt4.1", "qué modelo", "que modelo", "what model"]
if any(k in (prompt or "").lower() for k in modelo_keywords):
    st.info("ℹ️  El modelo usado por Copilot CLI es gestionado automáticamente por GitHub. No es posible elegir manualmente (por ejemplo, GPT-4.1); Copilot selecciona el mejor modelo disponible según tu suscripción.")
